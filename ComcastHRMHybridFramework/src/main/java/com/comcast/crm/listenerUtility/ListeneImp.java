...
public class ListeneImp implements ITestListener, ISuiteListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		test.log(Status.PASS, result.getMethod().getMethodName()).info(MarkupHelper.createLabel(test_name +"<b> ===> is PASSED</b>", ExtentColor.GREEN));
	...
	public void onTestFailure(ITestResult result) {
		...
		test.log(Status.FAIL, testName).info(MarkupHelper.createLabel(testName +"<b> ====> is FAILED</b>", ExtentColor.RED));
